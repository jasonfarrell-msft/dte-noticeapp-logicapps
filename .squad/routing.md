...
|-----------|----------|----------|
| Bicep/ARM templates | Grace | Infrastructure as code, module design, parameters |
| Azure provisioning | Grace | Resource groups, deployments, configuration |
| Architecture decisions | Hopper | Design review, scope decisions, trade-offs |
| Code review | Hopper | Review Bicep, check quality, suggest improvements |
| Testing | Lovelace | Validate deployments, test parameters, edge cases |
| Scope & priorities | Hopper | What to build next, trade-offs, decisions |
