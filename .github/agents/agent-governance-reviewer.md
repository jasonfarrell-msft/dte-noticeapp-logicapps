...
Start with a GovernancePolicy dataclass defining allowed/blocked tools and patterns
Add a @govern(policy) decorator to all tool functions
Add intent classification to the input processing pipeline
